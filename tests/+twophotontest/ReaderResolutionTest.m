...
%       runtests('twophotontest.ReaderResolutionTest')
    ...
    properties (TestParameter)
        ...
        FilenameCase = struct( ...
            'prairieView', struct( ...
                ...
                'className', 'nansen.module.twophoton.io.prairieview.PrairieViewTiffs'), ...
            'thorLabs', struct( ...
                'filename', 'ChanA_001_001_001_001.tif', ...
                'className', 'nansen.module.twophoton.io.thorlabs.ThorLabsTiffs'), ...
            'suite2pCorrected', struct( ...
                'filename', fullfile('plane0', 'reg_tif', 'file000_chan0.tif'), ...
                'className', 'nansen.module.twophoton.integration.suite2p.Suite2pCorrected'), ...
    ...
    methods (Test)
        ...
        function testSciScanRecordingIsResolvedByContent(testCase)
            ...
            testCase.verifyEqual(className, 'nansen.module.twophoton.io.sciscan.SciScanRaw')
        end
        ...
        function testScanImageTiffIsResolvedByContent(testCase)
            ...
            testCase.verifyEqual(className, 'nansen.module.twophoton.io.scanimage.ScanImageTiff')
        end
    end
end
