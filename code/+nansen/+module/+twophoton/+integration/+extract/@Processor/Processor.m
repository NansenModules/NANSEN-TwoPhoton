classdef Processor < nansen.module.twophoton.autosegmentation.RoiSegmentation & ...
                        nansen.wrapper.abstract.ToolboxWrapper
%nansen.module.twophoton.integration.extract.Processor Wrapper for running EXTRACT within nansen
%
%   h = nansen.module.twophoton.integration.extract.Processor(imageStackReference) runs extract
...
%
%   h = nansen.module.twophoton.integration.extract.Processor(__, options) additionally
%       specifies the options to use for the processor.
%
%   To get the default options:
%       defOptions = nansen.module.twophoton.integration.extract.Processor.getDefaultOptions()
%
...
% Rename to ExtractorS??
    ...
    properties (Constant) % Attributes inherited from nansen.processing.DataMethod
        ...
        OptionsManager nansen.manage.OptionsManager = ...
            nansen.OptionsManager('nansen.module.twophoton.integration.extract.Processor')
    end
    ...
    methods % Constructor
        ...
        %nansen.module.twophoton.integration.extract.Processor Construct extract processor
        %
        %   h = nansen.module.twophoton.integration.extract.Processor(imageStack) specifies the
        %   given ImageStack as a SourceStack for the EXTRACT processor.
        %
        %   See also nansen.stack.ImageStackProcessor/ImageStackProcessor

            obj@nansen.module.twophoton.autosegmentation.RoiSegmentation(varargin{:})
    ...
    methods (Access = protected) % Implementation of superclass methods
        ...
        function onInitialization(obj)
            onInitialization@nansen.module.twophoton.autosegmentation.RoiSegmentation(obj)
        ...
        function onCompletion(obj)
            ...
            onCompletion@nansen.module.twophoton.autosegmentation.RoiSegmentation(obj)
    ...
    methods (Access = protected) % Implementation of RoiSegmentation methods
        ...
        %   struct of parameters for the EXTRACT pipeline.
            ...
            import nansen.module.twophoton.integration.extract.Options
        ...
        %getRoiArray Get results as a roi array
            ...
            for i = 1:numZ
                for j = 1:numC
                    ...
                    roiArrayCell{i,j} = nansen.module.twophoton.integration.extract.convert2rois(...
        ...
        %   Include spatial weights as images for all rois.
            ...
            getRoiAppData@nansen.module.twophoton.autosegmentation.RoiSegmentation(obj)
    ...
    methods (Access = private) % Methods specific to the Extract Processor
        ...
        %   images for each roi.
            ...
            imArray = nansen.module.twophoton.integration.extract.util.convertSpatialWeightsToThumbnails(...
